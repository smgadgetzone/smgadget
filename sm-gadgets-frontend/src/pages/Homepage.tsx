...
import { ArrowRight, Battery, Headphones, Watch, Zap, Eye, TrendingUp, Monitor, Gamepad2, ShoppingCart, Package } from 'lucide-react';
        ...
        <section className="py-12 px-4 bg-gradient-to-r from-purple-500/10 via-indigo-500/5 to-transparent relative overflow-hidden">
          ...
          <div className="container mx-auto relative z-10">
            <div className="flex items-center justify-between mb-8">
              <div>
                <h2 className="text-3xl font-playfair font-bold mb-2 flex items-center gap-3">
                  <Package className="h-7 w-7 text-purple-500 animate-bounce" />
                  Exclusive Combos
                </h2>
                <p className="text-muted-foreground text-sm">Bundle & Save more on your favorite gadgets</p>
              </div>
            </div>
