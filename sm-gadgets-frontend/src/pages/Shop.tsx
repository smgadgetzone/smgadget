                      ...
                      <div className="flex flex-col gap-3 mt-auto pt-4">
                        ...
                        <div className="flex gap-2 w-full mt-1">
                          ...
                          <Button
                            ...
                            disabled={!product.inStock}
                            className="flex-1 shadow-md h-10 text-sm font-bold rounded-xl transition-transform hover:scale-[1.02] active:scale-95 bg-primary text-primary-foreground min-w-0 px-2"
                          >
